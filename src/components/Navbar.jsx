...
const Navbar = () => {
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4   ">
      {/* Important for the flex (1st part)  */}
      ...
      {/* Important for the flex (2nd part)  */}
      {/* search input */}
      ...
      {/* Important for the flex (3rd part)  */}

      {/* cart button */}
      <button className="hidden bg-black rounded-full text-white md:flex items-center py-2">
